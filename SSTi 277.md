...
Server-Side Template Injection via [email body] Parameter on [Personalization campaign ] Page
...
[Sendstack] [https://kzlabs.in/subdomains/templates/] [email body] parameter is vulnerable to server-side template injection.
...
`https://kzlabs.in/subdomains/templates/`

## Steps to Reproduce

1. Navigate to the following URL, or submit the following value in the [email body] field: `https://kzlabs.in/subdomains/templates/`
...
<img width="1434" height="1143" alt="image" src="https://github.com/user-attachments/assets/70464fef-364b-4201-8f4e-56925c9cc99a" />
...
<img width="1434" height="1143" alt="image" src="https://github.com/user-attachments/assets/639cee38-8561-4285-b1c8-7e1f27c70273" />
