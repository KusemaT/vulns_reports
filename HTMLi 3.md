...
HTML Injection via Premium Support Chat on home Page
...
LinkedIn https://kzlabs.store/chat/ support chat is vulnerable to HTML injection.
...
https://kzlabs.store/chat/

## Steps to Reproduce

1. Navigate to the following URL: `https://kzlabs.store/chat/`
2. Enter payload in support chat 
...
<img width="1792" height="1090" alt="image" src="https://github.com/user-attachments/assets/9db06c5e-ecf2-49a7-8d80-600259790d72" />


`Screenshot 2: Screenshot shows the injected HTML rendered on the page`

<img width="962" height="1099" alt="image" src="https://github.com/user-attachments/assets/f040f4ce-00ca-4f8f-8107-275679d909bf" />
