...
Server-Side Template Injection via [Email subject & body] Parameter on [Invoice & receipt template designer] Page
...
[Docucraft] [https://kzlabs.in/subdomains/erb/] [Email subject & body] parameter is vulnerable to server-side template injection.
...
`https://kzlabs.in/subdomains/erb/`

## Steps to Reproduce

1. Navigate to the following URL, or submit the following value in the [Email subject & body] field: `https://kzlabs.in/subdomains/erb/`
...
<img width="1434" height="1143" alt="image" src="https://github.com/user-attachments/assets/990475b3-fa6c-44e7-9642-eca14b192be0" />
...
<img width="1434" height="1143" alt="image" src="https://github.com/user-attachments/assets/0aeaaad7-3a26-484c-a11d-ac8ef1a34913" />
