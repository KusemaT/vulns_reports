...
Server-Side Template Injection via [First name] Parameter on [Create account] Page
...
[Glovo] [https://kzlabs.in/subdomains/onboarding/index.php] [First name] parameter is vulnerable to server-side template injection.
...
`https://kzlabs.in/subdomains/onboarding/index.php`

## Steps to Reproduce

1. Navigate to the following URL, or submit the following value in the [first name] field: `https://kzlabs.in/subdomains/onboarding/index.php`
...
<img width="1434" height="1143" alt="image" src="https://github.com/user-attachments/assets/b172e4d9-7511-49d5-b5f4-b2223a04e90f" />
...
<img width="1390" height="1099" alt="image" src="https://github.com/user-attachments/assets/a690ee45-8cc2-498a-bd85-189a54a1c0b0" />
